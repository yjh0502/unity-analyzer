...
pub struct Animation {
    ...
    pub m_CorrespondingSourceObject: Struct_m_CorrespondingSourceObject,
    pub m_PrefabInstance: Struct_m_CorrespondingSourceObject,
    pub m_PrefabAsset: Struct_m_CorrespondingSourceObject,
    pub m_GameObject: Struct_m_CorrespondingSourceObject,
    pub m_Enabled: usize,
    pub serializedVersion: usize,
    pub m_Animation: Struct_m_CorrespondingSourceObject,
    pub m_Animations: Vec<Struct_m_CorrespondingSourceObject>,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_CorrespondingSourceObject {
    pub fileID: String,
...
pub struct AnimationClip {
    pub m_ObjectHideFlags: usize,
    pub m_CorrespondingSourceObject: Option<Struct_m_CorrespondingSourceObject>,
    pub m_PrefabInstance: Option<Struct_m_CorrespondingSourceObject>,
    pub m_PrefabAsset: Option<Struct_m_CorrespondingSourceObject>,
    pub m_Name: String,
    pub serializedVersion: usize,
    pub m_Legacy: usize,
    ...
    pub m_PositionCurves: Vec<Struct_m_RotationCurves>,
    ...
    pub m_WrapMode: usize,
    pub m_Bounds: Struct_m_Bounds,
    pub m_ClipBindingConstant: Struct_m_ClipBindingConstant,
    pub m_AnimationClipSettings: Struct_m_AnimationClipSettings,
    pub m_EditorCurves: Vec<Struct_m_FloatCurves>,
    pub m_EulerEditorCurves: Vec<Struct_m_FloatCurves>,
    pub m_HasGenericRootTransform: usize,
    pub m_HasMotionFloatCurves: usize,
    pub m_Events: Vec<Struct_m_Events>,
    pub m_PrefabParentObject: Option<Struct_m_CorrespondingSourceObject>,
    pub m_PrefabInternal: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct Struct_m_Events {
    ...
    pub data: Option<()>,
    pub objectReferenceParameter: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_AnimationClipSettings {
    pub serializedVersion: usize,
    pub m_AdditiveReferencePoseClip: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_ClipBindingConstant {
    ...
    pub pptrCurveMapping: Vec<Struct_m_CorrespondingSourceObject>,
}
...
pub struct Struct_genericBindings {
    ...
    pub path: usize,
    pub attribute: usize,
    pub script: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_curve {
    pub time: f64,
    pub value: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_Curve {
    ...
    pub outWeight: Option<::serde_yaml::Value>,
}
...
pub struct Animator {
    pub serializedVersion: usize,
    pub m_ObjectHideFlags: usize,
    pub m_PrefabParentObject: Struct_m_CorrespondingSourceObject,
    pub m_PrefabInternal: Struct_m_CorrespondingSourceObject,
    pub m_GameObject: Struct_m_CorrespondingSourceObject,
    pub m_Enabled: usize,
    pub m_Avatar: Struct_m_CorrespondingSourceObject,
    pub m_Controller: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_AnimatorLayers {
    pub serializedVersion: usize,
    pub m_Name: String,
    pub m_StateMachine: Struct_m_CorrespondingSourceObject,
    pub m_Mask: Struct_m_CorrespondingSourceObject,
...
pub struct AnimatorState {
    ...
    pub m_Speed: usize,
    pub m_CycleOffset: usize,
    pub m_Transitions: Vec<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Motion: Struct_m_CorrespondingSourceObject,
    pub m_Tag: Option<()>,
...
pub struct AnimatorStateMachine {
    ...
    pub m_StateMachineTransitions: Struct_m_StateMachineTransitions,
    pub m_StateMachineBehaviours: Vec<::serde_yaml::Value>,
    ...
    pub m_DefaultState: Struct_m_CorrespondingSourceObject,
    pub m_PrefabParentObject: Option<Struct_m_CorrespondingSourceObject>,
    pub m_PrefabInternal: Option<Struct_m_CorrespondingSourceObject>,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_StateMachineTransitions {}
...
pub struct Struct_m_ChildStates {
    pub serializedVersion: usize,
    pub m_State: Struct_m_CorrespondingSourceObject,
    pub m_Position: Struct_m_Center,
}
...
pub struct AnimatorStateTransition {
    ...
    pub m_DstStateMachine: Struct_m_CorrespondingSourceObject,
    pub m_DstState: Struct_m_CorrespondingSourceObject,
    pub m_Solo: usize,
    pub m_Mute: usize,
    pub m_IsExit: usize,
    pub serializedVersion: usize,
...
pub struct AudioSource {
    ...
    pub m_Enabled: usize,
    pub serializedVersion: usize,
    pub OutputAudioMixerGroup: Struct_m_CorrespondingSourceObject,
    pub m_audioClip: Struct_m_CorrespondingSourceObject,
    ...
    pub rolloffCustomCurve: Struct_curve_1,
    pub panLevelCustomCurve: Struct_curve_1,
    pub spreadCustomCurve: Struct_curve_1,
    pub reverbZoneMixCustomCurve: Struct_curve_1,
}
...
pub struct BoxCollider {
    ...
    pub m_PrefabInternal: Option<Struct_m_CorrespondingSourceObject>,
    pub m_GameObject: Struct_m_CorrespondingSourceObject,
    pub m_Material: Struct_m_CorrespondingSourceObject,
...
pub struct Camera {
    ...
    pub m_PrefabParentObject: Option<Struct_m_CorrespondingSourceObject>,
    pub m_PrefabInternal: Option<Struct_m_CorrespondingSourceObject>,
    pub m_GameObject: Option<Struct_m_CorrespondingSourceObject>,
    pub m_Enabled: Option<usize>,
    pub serializedVersion: Option<usize>,
    pub m_ClearFlags: Option<usize>,
    pub m_BackGroundColor: Option<Struct_m_BackGroundColor>,
    ...
    pub m_TargetTexture: Option<Struct_m_CorrespondingSourceObject>,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_BackGroundColor {
    pub r: f64,
    pub g: f64,
    pub b: f64,
    pub a: f64,
...
pub struct Canvas {
    ...
    pub m_Camera: Struct_m_CorrespondingSourceObject,
...
pub struct ConfigurableJoint {
    ...
    pub m_PrefabAsset: Struct_m_CorrespondingSourceObject,
    pub m_GameObject: Struct_m_CorrespondingSourceObject,
    pub m_ConnectedBody: Struct_m_CorrespondingSourceObject,
...
pub struct EditorBuildSettings {
    ...
    pub m_configObjects: Struct_m_StateMachineTransitions,
}
...
pub struct EditorSettings {
    ...
    pub m_PrefabRegularEnvironment: Struct_m_CorrespondingSourceObject,
    pub m_PrefabUIEnvironment: Struct_m_CorrespondingSourceObject,
...
pub struct GameObject {
    ...
    pub m_Icon: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct Struct_m_Component {
    pub component: Option<Struct_m_CorrespondingSourceObject>,
}
...
pub struct GraphicsSettings {
    ...
    pub m_AlwaysIncludedShaders: Vec<Struct_m_CorrespondingSourceObject>,
    pub m_PreloadedShaders: Vec<::serde_yaml::Value>,
    pub m_SpritesDefaultMaterial: Struct_m_CorrespondingSourceObject,
    pub m_CustomRenderPipeline: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_Deferred {
    pub m_Mode: usize,
    pub m_Shader: Struct_m_CorrespondingSourceObject,
}
...
pub struct Light {
    ...
    pub serializedVersion: usize,
    pub m_Type: usize,
    pub m_Color: Struct_m_BackGroundColor,
    pub m_Intensity: f64,
    pub m_Range: f64,
    pub m_SpotAngle: f64,
    pub m_CookieSize: usize,
    pub m_Shadows: Struct_m_Shadows,
    pub m_Cookie: Struct_m_CorrespondingSourceObject,
    pub m_DrawHalo: usize,
    pub m_Flare: Struct_m_CorrespondingSourceObject,
    pub m_RenderMode: usize,
...
pub struct LightmapSettings {
    ...
    pub m_LightingDataAsset: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_LightmapEditorSettings {
    ...
    pub m_Padding: usize,
    pub m_LightmapParameters: Struct_m_CorrespondingSourceObject,
...
pub struct Mesh {
    ...
    pub m_LocalAABB: Struct_m_Bounds,
...
pub struct MeshCollider {
    ...
    pub m_Mesh: Struct_m_CorrespondingSourceObject,
...
pub struct MeshRenderer {
    ...
    pub m_Materials: Vec<Struct_m_CorrespondingSourceObject>,
    pub m_StaticBatchInfo: Option<Struct_m_StaticBatchInfo>,
    pub m_StaticBatchRoot: Struct_m_CorrespondingSourceObject,
    pub m_ProbeAnchor: Struct_m_CorrespondingSourceObject,
    pub m_LightProbeVolumeOverride: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct MonoBehaviour {
    ...
    pub m_Script: Struct_m_CorrespondingSourceObject,
    pub m_Name: Option<String>,
    ...
    pub workSlotOpenAnimClip: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub dithering: Option<Struct_dithering>,
    ...
    pub lumVsSatCurve: Option<Struct_satVsSatCurve>,
    pub m_Material: Option<Struct_m_CorrespondingSourceObject>,
    pub m_Color: Option<Struct_m_BackGroundColor>,
    ...
    pub m_TargetGraphic: Option<Struct_m_CorrespondingSourceObject>,
    pub m_OnClick: Option<Struct_m_OnClick>,
    pub m_Sprite: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub gunGameObject: Option<Struct_m_CorrespondingSourceObject>,
    pub spawnLocation: Option<Struct_m_CorrespondingSourceObject>,
    pub title: Option<Struct_m_CorrespondingSourceObject>,
    pub description: Option<Struct_m_CorrespondingSourceObject>,
    pub navigationDetails: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub sharedProfile: Option<Struct_m_CorrespondingSourceObject>,
    pub isGlobal: Option<usize>,
    pub blendDistance: Option<usize>,
    pub weight: Option<usize>,
    pub priority: Option<usize>,
    pub volumeTrigger: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Resources: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub gunEnd: Option<Struct_m_CorrespondingSourceObject>,
    pub muzzleFlash: Option<Struct_m_CorrespondingSourceObject>,
    pub cartridgeEjection: Option<Struct_m_CorrespondingSourceObject>,
    pub metalHitEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub sandHitEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub stoneHitEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub waterLeakEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub waterLeakExtinguishEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub fleshHitEffects: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub woodHitEffect: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_FirstSelected: Option<Struct_m_CorrespondingSourceObject>,
    pub m_sendNavigationEvents: Option<usize>,
    pub m_DragThreshold: Option<usize>,
    pub fireParticleSystem: Option<Struct_m_CorrespondingSourceObject>,
    pub smokeParticleSystem: Option<Struct_m_CorrespondingSourceObject>,
    pub lifeTime: Option<f64>,
    pub selectedAppIndex: Option<usize>,
    pub clientTokens: Option<Vec<Option<()>>>,
    pub appIds: Option<Vec<usize>>,
    ...
    pub hashCode: Option<isize>,
    pub material: Option<Struct_m_CorrespondingSourceObject>,
    pub materialHashCode: Option<isize>,
    pub m_Version: Option<String>,
    pub m_SourceFontFileGUID: Option<String>,
    pub m_SourceFontFile_EditorRef: Option<Struct_m_CorrespondingSourceObject>,
    pub m_SourceFontFile: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_AtlasTextures: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    ...
    pub atlas: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub variableJoystick: Option<Struct_m_CorrespondingSourceObject>,
    pub valueText: Option<Struct_m_CorrespondingSourceObject>,
    pub background: Option<Struct_m_CorrespondingSourceObject>,
    pub axisSprites: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub m_Template: Option<Struct_m_CorrespondingSourceObject>,
    pub m_CaptionText: Option<Struct_m_CorrespondingSourceObject>,
    pub m_CaptionImage: Option<Struct_m_CorrespondingSourceObject>,
    pub m_ItemText: Option<Struct_m_CorrespondingSourceObject>,
    pub m_ItemImage: Option<Struct_m_CorrespondingSourceObject>,
    pub m_Value: Option<usize>,
    pub m_Options: Option<Struct_m_Options>,
    pub m_OnValueChanged: Option<Struct_m_OnValueChanged>,
    pub m_HandleRect: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub graphic: Option<Struct_m_CorrespondingSourceObject>,
    pub m_Group: Option<Struct_m_CorrespondingSourceObject>,
    pub onValueChanged: Option<Struct_onValueChanged>,
    pub m_IsOn: Option<usize>,
    pub m_Content: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Viewport: Option<Struct_m_CorrespondingSourceObject>,
    pub m_HorizontalScrollbar: Option<Struct_m_CorrespondingSourceObject>,
    pub m_VerticalScrollbar: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub rb: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub handle: Option<Struct_m_CorrespondingSourceObject>,
    pub moveThreshold: Option<usize>,
    pub joystickType: Option<usize>,
    pub m_AgentTypeID: Option<isize>,
    ...
    pub m_BakedNavMeshData: Option<Struct_m_CorrespondingSourceObject>,
    pub m_NavMesh: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Behaviour: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Prefab: Option<Struct_m_CorrespondingSourceObject>,
    pub m_KeyCode: Option<usize>,
    pub m_Tracked: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Filters: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    ...
    pub m_Tiles: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub m_Curve: Option<Struct_m_Curve_1>,
    ...
    pub anchor: Option<Struct_m_BackGroundColor>,
    pub anchorHighlighted: Option<Struct_m_BackGroundColor>,
    pub anchorSelected: Option<Struct_m_BackGroundColor>,
    pub control: Option<Struct_m_BackGroundColor>,
    pub controlHighlighted: Option<Struct_m_BackGroundColor>,
    pub controlSelected: Option<Struct_m_BackGroundColor>,
    pub handleDisabled: Option<Struct_m_BackGroundColor>,
    pub controlLine: Option<Struct_m_BackGroundColor>,
    pub bezierPath: Option<Struct_m_BackGroundColor>,
    pub highlightedPath: Option<Struct_m_BackGroundColor>,
    pub bounds: Option<Struct_m_BackGroundColor>,
    pub segmentBounds: Option<Struct_m_BackGroundColor>,
    pub vertexPath: Option<Struct_m_BackGroundColor>,
    pub normals: Option<Struct_m_BackGroundColor>,
    pub normalsLength: Option<usize>,
    pub pathCreator: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub waypoints: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub autoUpdate: Option<usize>,
    pub prefab: Option<Struct_m_CorrespondingSourceObject>,
    pub holder: Option<Struct_m_CorrespondingSourceObject>,
    pub spacing: Option<f64>,
    pub pathPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub followerPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub spawnPoints: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub roadWidth: Option<usize>,
    pub thickness: Option<f64>,
    pub flattenSurface: Option<usize>,
    pub roadMaterial: Option<Struct_m_CorrespondingSourceObject>,
    pub undersideMaterial: Option<Struct_m_CorrespondingSourceObject>,
    pub textureTiling: Option<usize>,
    pub meshHolder: Option<Struct_m_CorrespondingSourceObject>,
    pub list: Option<Vec<Struct_list>>,
    pub foldoutSettings: Option<usize>,
    pub lastCamID: Option<usize>,
    pub lastCam: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub Color: Option<Struct_m_BackGroundColor>,
    ...
    pub automateForPlatforms: Option<usize>,
    ...
    pub Status: Option<Struct_m_CorrespondingSourceObject>,
    pub Msg: Option<Struct_m_CorrespondingSourceObject>,
    pub RewardedAd: Option<usize>,
    pub floats: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_fontAsset: Option<Struct_m_CorrespondingSourceObject>,
    pub m_sharedMaterial: Option<Struct_m_CorrespondingSourceObject>,
    pub m_fontSharedMaterials: Option<Vec<::serde_yaml::Value>>,
    pub m_fontMaterial: Option<Struct_m_CorrespondingSourceObject>,
    pub m_fontMaterials: Option<Vec<::serde_yaml::Value>>,
    pub m_fontColor32: Option<Struct_m_fontColor32>,
    pub m_fontColor: Option<Struct_m_BackGroundColor>,
    ...
    pub m_fontColorGradientPreset: Option<Struct_m_CorrespondingSourceObject>,
    pub m_spriteAsset: Option<Struct_m_CorrespondingSourceObject>,
    pub m_tintAllSprites: Option<usize>,
    pub m_overrideHtmlColors: Option<usize>,
    pub m_faceColor: Option<Struct_m_fontColor32>,
    pub m_outlineColor: Option<Struct_m_fontColor32>,
    ...
    pub m_linkedTextComponent: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_spriteAnimator: Option<Struct_m_CorrespondingSourceObject>,
    pub m_isInputParsingRequired: Option<usize>,
    pub m_inputSource: Option<usize>,
    pub m_hasFontAssetChanged: Option<usize>,
    pub m_subTextObjects: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub m_baseMaterial: Option<Struct_m_CorrespondingSourceObject>,
    pub m_maskOffset: Option<Struct_m_Center>,
    pub text: Option<Struct_m_CorrespondingSourceObject>,
    pub duration: Option<usize>,
    pub anchoredSpeed: Option<Struct_m_Center>,
    pub cam: Option<Struct_m_CorrespondingSourceObject>,
    pub scrollTime: Option<f64>,
    pub curve: Option<Struct_curve_1>,
    pub camera: Option<Struct_m_CorrespondingSourceObject>,
    pub money: Option<usize>,
    pub target: Option<Struct_m_CorrespondingSourceObject>,
    pub rotationVector: Option<Struct_m_Center>,
    pub copyTarget: Option<Struct_m_CorrespondingSourceObject>,
    pub randomVillagerCreator: Option<Struct_m_CorrespondingSourceObject>,
    pub boxCollider: Option<Struct_m_CorrespondingSourceObject>,
    pub anim: Option<Struct_m_CorrespondingSourceObject>,
    pub remainTimer: Option<usize>,
    pub spawnRateOnSelectedArea: Option<usize>,
    pub danceClip: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub radius: Option<f64>,
    pub pivot: Option<Struct_m_Center>,
    pub walkAnim: Option<Struct_m_CorrespondingSourceObject>,
    pub stopAnim: Option<Struct_m_CorrespondingSourceObject>,
    pub currentArea: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub bgOn: Option<Struct_m_CorrespondingSourceObject>,
    pub bgOff: Option<Struct_m_CorrespondingSourceObject>,
    pub bgTimer: Option<Struct_m_CorrespondingSourceObject>,
    pub discountPop: Option<Struct_m_CorrespondingSourceObject>,
    pub openPop: Option<Struct_m_CorrespondingSourceObject>,
    pub costTexts: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub timeText: Option<Struct_m_CorrespondingSourceObject>,
    pub timeTimertext: Option<Struct_m_CorrespondingSourceObject>,
    pub fillImage: Option<Struct_m_CorrespondingSourceObject>,
    pub area: Option<Struct_m_CorrespondingSourceObject>,
    pub endTime: Option<usize>,
    pub worldPos: Option<Struct_m_Center>,
    pub hide: Option<usize>,
    pub techIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub techRequireIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub buildingImage: Option<Struct_m_CorrespondingSourceObject>,
    pub nameText: Option<Struct_m_CorrespondingSourceObject>,
    pub moneyText: Option<Struct_m_CorrespondingSourceObject>,
    pub populationText: Option<Struct_m_CorrespondingSourceObject>,
    pub techText: Option<Struct_m_CorrespondingSourceObject>,
    pub requireText: Option<Struct_m_CorrespondingSourceObject>,
    pub notConstructableText: Option<Struct_m_CorrespondingSourceObject>,
    pub buttonOn: Option<Struct_m_CorrespondingSourceObject>,
    pub buttonOff: Option<Struct_m_CorrespondingSourceObject>,
    pub lockPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub notConstructablePanel: Option<Struct_m_CorrespondingSourceObject>,
    pub biomeDisplays: Option<Vec<Struct_biomeDisplays>>,
    pub allBiomeDisplay: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub buildElementPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub content: Option<Struct_m_CorrespondingSourceObject>,
    pub buildingTypeOrder: Option<String>,
    pub hidePosY: Option<isize>,
    pub showPosY: Option<f64>,
    pub showTime: Option<usize>,
    pub buildElements: Option<Vec<::serde_yaml::Value>>,
    pub errorText: Option<Struct_m_CorrespondingSourceObject>,
    pub buttonBuildOn: Option<Struct_m_CorrespondingSourceObject>,
    pub buttonBuildOff: Option<Struct_m_CorrespondingSourceObject>,
    pub buttonCancel: Option<Struct_m_CorrespondingSourceObject>,
    pub errorDesc: Option<Struct_m_CorrespondingSourceObject>,
    pub zoomSize: Option<usize>,
    pub centerOffsetZ: Option<usize>,
    pub descText: Option<Struct_m_CorrespondingSourceObject>,
    pub skillNameText: Option<Struct_m_CorrespondingSourceObject>,
    pub cooldownText: Option<Struct_m_CorrespondingSourceObject>,
    pub moneyIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub techIcons: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub skillObject: Option<Struct_m_CorrespondingSourceObject>,
    pub lvLackMessage: Option<Struct_m_CorrespondingSourceObject>,
    pub noSkillMessage: Option<Struct_m_CorrespondingSourceObject>,
    pub cooldownMessage: Option<Struct_m_CorrespondingSourceObject>,
    pub skillOnBtn: Option<Struct_m_CorrespondingSourceObject>,
    pub skillOffBtn: Option<Struct_m_CorrespondingSourceObject>,
    pub skillOnImage: Option<Struct_m_CorrespondingSourceObject>,
    pub skillOffImage: Option<Struct_m_CorrespondingSourceObject>,
    pub skillOnFillImage: Option<Struct_m_CorrespondingSourceObject>,
    pub skillFillButtonImage: Option<Struct_m_CorrespondingSourceObject>,
    pub titleText: Option<Struct_m_CorrespondingSourceObject>,
    pub adCollectButton: Option<Struct_m_CorrespondingSourceObject>,
    pub collectButton: Option<Struct_m_CorrespondingSourceObject>,
    pub adFreeButton: Option<Struct_m_CorrespondingSourceObject>,
    pub height: Option<usize>,
    pub m_renderer: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub moneyPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub populationPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub moneyTransform: Option<Struct_m_CorrespondingSourceObject>,
    pub populationTransform: Option<Struct_m_CorrespondingSourceObject>,
    pub earnText: Option<Struct_m_CorrespondingSourceObject>,
    pub biomeText: Option<Struct_m_CorrespondingSourceObject>,
    pub buildingUpgradeText: Option<Struct_m_CorrespondingSourceObject>,
    pub peopleUpgradeText: Option<Struct_m_CorrespondingSourceObject>,
    pub speedUpgradeText: Option<Struct_m_CorrespondingSourceObject>,
    pub biomeAreaList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub biomeIconList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub medal: Option<Struct_m_CorrespondingSourceObject>,
    pub upgradeColor: Option<Struct_m_BackGroundColor>,
    pub upgradeMaxColor: Option<Struct_m_BackGroundColor>,
    pub managementElementPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub movable: Option<usize>,
    pub cycle: Option<usize>,
    pub amount: Option<usize>,
    pub progressBar: Option<Struct_m_CorrespondingSourceObject>,
    pub bg_1: Option<Struct_m_CorrespondingSourceObject>,
    pub bg_2: Option<Struct_m_CorrespondingSourceObject>,
    pub startHeight: Option<usize>,
    pub endHeight: Option<usize>,
    pub imageOn: Option<Struct_m_CorrespondingSourceObject>,
    pub imageOff: Option<Struct_m_CorrespondingSourceObject>,
    pub iconUp: Option<Struct_m_CorrespondingSourceObject>,
    pub iconDown: Option<Struct_m_CorrespondingSourceObject>,
    pub iconUpOff: Option<Struct_m_CorrespondingSourceObject>,
    pub iconDownOff: Option<Struct_m_CorrespondingSourceObject>,
    pub button: Option<Struct_m_CorrespondingSourceObject>,
    pub btnLock: Option<Struct_m_CorrespondingSourceObject>,
    pub btnOn: Option<Struct_m_CorrespondingSourceObject>,
    pub btnPurchase: Option<Struct_m_CorrespondingSourceObject>,
    pub skillIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub techIconColorOn: Option<Struct_m_BackGroundColor>,
    pub techIconColorOff: Option<Struct_m_BackGroundColor>,
    pub buttons: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub disableImage: Option<Struct_m_CorrespondingSourceObject>,
    pub typeIconList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub levelSpotList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub techSelectElement: Option<Struct_m_CorrespondingSourceObject>,
    pub levelDescText: Option<Struct_m_CorrespondingSourceObject>,
    pub techType: Option<usize>,
    pub techTreeElementList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub elementInfoList: Option<Vec<Struct_elementInfoList>>,
    pub panelButtons: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub panels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub buttonOnSprites: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub buttonOffSprites: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub gauge: Option<Struct_m_CorrespondingSourceObject>,
    pub levelText: Option<Struct_m_CorrespondingSourceObject>,
    pub expText: Option<Struct_m_CorrespondingSourceObject>,
    pub levelUpButton: Option<Struct_m_CorrespondingSourceObject>,
    pub fillGauge: Option<Struct_m_CorrespondingSourceObject>,
    pub upgradeElementPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub upgradeElements: Option<Vec<::serde_yaml::Value>>,
    pub cardPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub synergyElementPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub synergyContent: Option<Struct_m_CorrespondingSourceObject>,
    pub selectPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub synergyPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub selectNameText: Option<Struct_m_CorrespondingSourceObject>,
    pub selectMoneyText: Option<Struct_m_CorrespondingSourceObject>,
    pub selectPopulationText: Option<Struct_m_CorrespondingSourceObject>,
    pub selectedBuildingImage: Option<Struct_m_CorrespondingSourceObject>,
    pub cardElements: Option<Vec<::serde_yaml::Value>>,
    pub btn: Option<Struct_m_CorrespondingSourceObject>,
    pub bgInfos: Option<Vec<Struct_bgInfos>>,
    pub bgOffPopul: Option<Struct_m_CorrespondingSourceObject>,
    pub nameTexts: Option<Vec<::serde_yaml::Value>>,
    pub priceTexts: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub pricePopulationTexts: Option<Vec<::serde_yaml::Value>>,
    pub kind: Option<usize>,
    pub level: Option<usize>,
    pub skillElementPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub skillType: Option<usize>,
    pub icon: Option<Struct_m_CorrespondingSourceObject>,
    pub contents: Option<Struct_m_CorrespondingSourceObject>,
    pub worldPosGap: Option<Struct_m_Center>,
    pub imageInfoList: Option<Vec<Struct_imageInfoList>>,
    pub p: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    #[serde(rename = "type")]
    pub field_type: Option<usize>,
    pub entry: Option<Struct_m_CorrespondingSourceObject>,
    pub workSlots: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub upgrades: Option<Struct_upgrades>,
    pub facilityLevel: Option<usize>,
    pub earn: Option<usize>,
    pub population: Option<usize>,
    pub workLocation: Option<Struct_m_CorrespondingSourceObject>,
    pub humanWorkType: Option<usize>,
    pub isAnimPlayOnce: Option<usize>,
    pub worker: Option<Struct_m_CorrespondingSourceObject>,
    pub building: Option<Struct_m_CorrespondingSourceObject>,
    pub liftDownLocation: Option<Struct_m_CorrespondingSourceObject>,
    pub modelSlots: Option<Vec<Struct_modelSlots>>,
    pub tierObjectInfo: Option<Vec<Struct_tierObjectInfo>>,
    pub firstWorkSlot: Option<Struct_m_CorrespondingSourceObject>,
    pub specialBuildingModel: Option<Struct_m_CorrespondingSourceObject>,
    pub techExp: Option<usize>,
    pub isSpecialBuilding: Option<usize>,
    pub upgradeCostMultiplier: Option<usize>,
    pub humanPrefabTest: Option<Struct_m_CorrespondingSourceObject>,
    pub animalPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub animalNum: Option<usize>,
    pub isOpen: Option<usize>,
    pub moneyProgressBar: Option<Struct_m_CorrespondingSourceObject>,
    pub workPosInfos: Option<Vec<Struct_workPosInfos>>,
    pub goWorkSpeed: Option<usize>,
    pub creator: Option<Struct_m_CorrespondingSourceObject>,
    pub humanAnim: Option<Struct_m_CorrespondingSourceObject>,
    pub currentWorkSlotEntry: Option<Struct_m_CorrespondingSourceObject>,
    pub currentWorkSlot: Option<Struct_m_CorrespondingSourceObject>,
    pub human: Option<Struct_m_CorrespondingSourceObject>,
    pub rightHand: Option<Struct_m_CorrespondingSourceObject>,
    pub leftHand: Option<Struct_m_CorrespondingSourceObject>,
    pub body: Option<Struct_m_CorrespondingSourceObject>,
    pub walkClip: Option<Struct_m_CorrespondingSourceObject>,
    pub defaultClip: Option<Struct_m_CorrespondingSourceObject>,
    pub animationInfos: Option<Vec<Struct_animationInfos>>,
    pub carryingAnimationInfos: Option<Vec<Struct_carryingAnimationInfos>>,
    pub area1: Option<Struct_m_CorrespondingSourceObject>,
    pub area2: Option<Struct_m_CorrespondingSourceObject>,
    pub area1Slots: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub area2Slots: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub area1Entry: Option<Struct_m_CorrespondingSourceObject>,
    pub area2Entry: Option<Struct_m_CorrespondingSourceObject>,
    pub modelInfos: Option<Vec<Struct_modelInfos>>,
    pub tunnelPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub modelHolder: Option<Struct_m_CorrespondingSourceObject>,
    pub navMeshCollider: Option<Struct_m_CorrespondingSourceObject>,
    pub tunnelNavMeshCollider: Option<Struct_m_CorrespondingSourceObject>,
    pub modelExplodeClip: Option<Struct_m_CorrespondingSourceObject>,
    pub open: Option<usize>,
    pub requireTownHallLv: Option<usize>,
    pub isMountain: Option<usize>,
    pub model: Option<Struct_m_CorrespondingSourceObject>,
    pub cards: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub reward: Option<Struct_reward>,
    pub rootingEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub projectionCam: Option<Struct_m_CorrespondingSourceObject>,
    pub shader: Option<Struct_m_CorrespondingSourceObject>,
    pub inputTex: Option<Struct_m_CorrespondingSourceObject>,
    pub noiseShader: Option<Struct_m_CorrespondingSourceObject>,
    pub noiseTex: Option<Struct_m_CorrespondingSourceObject>,
    pub addTexture: Option<Struct_m_CorrespondingSourceObject>,
    pub camPivot: Option<Struct_m_CorrespondingSourceObject>,
    pub floor: Option<Struct_m_CorrespondingSourceObject>,
    pub autoApplyValue: Option<usize>,
    pub bgColor: Option<Struct_m_BackGroundColor>,
    pub inkColor: Option<Struct_m_BackGroundColor>,
    ...
    pub tileFloor: Option<Struct_m_CorrespondingSourceObject>,
    pub borders: Option<::serde_yaml::Value>,
    pub biomeInfos: Option<Vec<Struct_biomeInfos>>,
    pub tileFloors: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub walls: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub generatedBorders: Option<Vec<::serde_yaml::Value>>,
    pub scrap: Option<Struct_m_CorrespondingSourceObject>,
    pub size: Option<::serde_yaml::Value>,
    pub buildPos: Option<Struct_m_CorrespondingSourceObject>,
    pub biome: Option<Struct_m_CorrespondingSourceObject>,
    pub openEffect: Option<Struct_m_CorrespondingSourceObject>,
    pub scrapRemoved: Option<usize>,
    pub areaTimerRunning: Option<usize>,
    pub areaTimerIdx: Option<usize>,
    pub adjoinAreas: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub corners: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub adjoinColor: Option<Struct_m_BackGroundColor>,
    pub defaultColor: Option<Struct_m_BackGroundColor>,
    pub biomeObject: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub areaN: Option<Struct_m_CorrespondingSourceObject>,
    pub areaE: Option<Struct_m_CorrespondingSourceObject>,
    pub areaW: Option<Struct_m_CorrespondingSourceObject>,
    pub areaS: Option<Struct_m_CorrespondingSourceObject>,
    pub head: Option<Struct_m_CorrespondingSourceObject>,
    pub eyes: Option<Struct_m_CorrespondingSourceObject>,
    pub hairBase: Option<Struct_m_CorrespondingSourceObject>,
    pub hairFront: Option<Struct_m_CorrespondingSourceObject>,
    pub hairDeco: Option<Struct_m_CorrespondingSourceObject>,
    pub handOrigins: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub bodyModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub eyeModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub hairBaseModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub hairFrontModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub hairDecoModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub facialHairModels: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub skinMaterials: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub bodyMaterials: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub hairMaterials: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub eyesMaterials: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    ...
    pub Logo: Option<Struct_m_CorrespondingSourceObject>,
    pub UpdateIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub InfoIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub DeleteIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub GameIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub HomeIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub InstrumentIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub QuestionIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub UserIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub AmazonIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub GooglePlayIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub iosIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub macIcon: Option<Struct_m_CorrespondingSourceObject>,
    pub windowsPhoneIcon: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub mesh: Option<Struct_m_CorrespondingSourceObject>,
    pub physicMaterial: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub mainCam: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub removeScrapUI: Option<Struct_m_CorrespondingSourceObject>,
    pub constructPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub upgradePanel: Option<Struct_m_CorrespondingSourceObject>,
    pub inventory: Option<Struct_m_CorrespondingSourceObject>,
    pub m_EventMask: Option<Struct_m_CullingMask>,
    pub m_MaxRayIntersections: Option<usize>,
    pub safeRect: Option<Struct_m_CorrespondingSourceObject>,
    pub simulate: Option<usize>,
    pub ui: Option<Struct_m_CorrespondingSourceObject>,
    pub initArea: Option<Struct_m_CorrespondingSourceObject>,
    pub areaList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub humanList: Option<Vec<::serde_yaml::Value>>,
    pub passages: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub buildingPrefabList: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub humanPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub dataTable: Option<Struct_m_CorrespondingSourceObject>,
    pub humanNum: Option<usize>,
    pub selectedArea: Option<Struct_m_CorrespondingSourceObject>,
    pub game: Option<Struct_m_CorrespondingSourceObject>,
    pub passagePopup: Option<Struct_m_CorrespondingSourceObject>,
    pub passageTimerDisplay: Option<Struct_m_CorrespondingSourceObject>,
    pub globalGameData: Option<Struct_m_CorrespondingSourceObject>,
    pub selectedPassage: Option<Struct_m_CorrespondingSourceObject>,
    pub tileSize: Option<f64>,
    pub tileOrigin: Option<Struct_m_CorrespondingSourceObject>,
    pub passageOrigin: Option<Struct_m_CorrespondingSourceObject>,
    pub minTypeInfos: Option<Vec<Struct_minTypeInfos>>,
    pub tilePrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub passagePrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub buildPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub buildPopup: Option<Struct_m_CorrespondingSourceObject>,
    pub buildingInfoPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub managementPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub claimPopup: Option<Struct_m_CorrespondingSourceObject>,
    pub techTreePopup: Option<Struct_m_CorrespondingSourceObject>,
    pub floatingsGenerator: Option<Struct_m_CorrespondingSourceObject>,
    pub techGuidePopup: Option<Struct_m_CorrespondingSourceObject>,
    pub tutorialPopup: Option<Struct_m_CorrespondingSourceObject>,
    pub tutorialFocus: Option<Struct_m_CorrespondingSourceObject>,
    pub areaTimerDisplayPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub plusMoneyIndicatorPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub cardGetIndicatorPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub moneyProgressBarPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub bigMoneyProgressBarPrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub progressBarHolder: Option<Struct_m_CorrespondingSourceObject>,
    pub indicatorHolder: Option<Struct_m_CorrespondingSourceObject>,
    pub TimerHolder: Option<Struct_m_CorrespondingSourceObject>,
    pub startFadeInImage: Option<Struct_m_CorrespondingSourceObject>,
    pub ActiveWhileShowPopup: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub HideWhileShowPopup: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub hideDuringTutorials: Option<Vec<Struct_hideDuringTutorials>>,
    pub debugPanel: Option<Struct_m_CorrespondingSourceObject>,
    pub globalUIData: Option<Struct_m_CorrespondingSourceObject>,
    pub isPopupShow: Option<usize>,
    pub pauseUpdatePopulation: Option<usize>,
    pub isTutorialRunning: Option<usize>,
    pub isTutorialPopupOpen: Option<usize>,
    pub areaTimerDisplays: Option<Vec<::serde_yaml::Value>>,
    pub sizeRange: Option<Struct_startInterval>,
    pub centerPos: Option<Struct_m_CorrespondingSourceObject>,
    pub selectZoomSize: Option<usize>,
    pub zoomSpeed: Option<f64>,
    pub touchMoveDamping: Option<usize>,
    pub isScrolling: Option<usize>,
    pub adHuman: Option<Struct_m_CorrespondingSourceObject>,
    pub areaSillhouettePrefab: Option<Struct_m_CorrespondingSourceObject>,
    pub worldMinPos: Option<Struct_m_Center>,
    pub worldMaxPos: Option<Struct_m_Center>,
    pub navMeshSurface: Option<Struct_m_CorrespondingSourceObject>,
    pub navMeshBackUp: Option<Struct_m_CorrespondingSourceObject>,
    pub worldRoot: Option<Struct_m_CorrespondingSourceObject>,
    pub areaNavMeshColliderPrefab: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub touchManager: Option<Struct_m_CorrespondingSourceObject>,
    pub exp: Option<usize>,
    pub cash: Option<usize>,
    pub tableLevelData: Option<Struct_m_CorrespondingSourceObject>,
    pub tableSlotData: Option<Struct_m_CorrespondingSourceObject>,
    pub tableOpenData: Option<Struct_m_CorrespondingSourceObject>,
    pub tableTechLevelData: Option<Struct_m_CorrespondingSourceObject>,
    pub tableTechBonusData: Option<Struct_m_CorrespondingSourceObject>,
    pub tableTechSkillData: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_NavMeshData: Option<Struct_m_CorrespondingSourceObject>,
    pub Player: Option<Struct_m_CorrespondingSourceObject>,
    pub PlayerCamera: Option<Struct_m_CorrespondingSourceObject>,
    pub FirstViewPlayerCamera: Option<Struct_m_CorrespondingSourceObject>,
    pub turnSpeed: Option<usize>,
    pub recordName: Option<()>,
    pub readDelay: Option<usize>,
    pub tableUpgradeData: Option<Struct_m_CorrespondingSourceObject>,
    pub virtualLands: Option<Vec<Struct_virtualLands>>,
    pub cheaperPrice: Option<usize>,
    pub Stop: Option<usize>,
    pub passageDisplay: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub passage: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_ResourcesAsset: Option<Struct_m_CorrespondingSourceObject>,
    pub m_ShaderVariantLogLevel: Option<usize>,
    pub placeUnder: Option<usize>,
    pub parentForPrefabs: Option<Struct_m_CorrespondingSourceObject>,
    pub _lineCount: Option<usize>,
    pub _vertexCount: Option<usize>,
    pub _mesh: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub wayPoints: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub segmentPrefab: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub Follower: Option<Struct_m_CorrespondingSourceObject>,
    pub generated: Option<Struct_m_CorrespondingSourceObject>,
    pub spriteSheet: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_defaultFontAsset: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_defaultSpriteAsset: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_defaultStyleSheet: Option<Struct_m_CorrespondingSourceObject>,
    pub m_leadingCharacters: Option<Struct_m_CorrespondingSourceObject>,
    pub m_followingCharacters: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct Struct_m_SpriteGlyphTable {
    ...
    pub sprite: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_fogs {
    pub fogSE: Struct_m_CorrespondingSourceObject,
    pub fogSW: Struct_m_CorrespondingSourceObject,
    pub fogE: Struct_m_CorrespondingSourceObject,
    pub fogS: Struct_m_CorrespondingSourceObject,
    pub fogW: Struct_m_CorrespondingSourceObject,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_hideDuringTutorials {
    pub tutorialEvent: usize,
    pub objects: Vec<Struct_m_CorrespondingSourceObject>,
}
...
pub struct Struct_biomeInfos {
    pub biomeType: usize,
    pub biomeMat: Struct_m_CorrespondingSourceObject,
    pub borderPrefabs: Vec<Struct_m_CorrespondingSourceObject>,
    pub wallPrefabs: Option<Vec<Struct_m_CorrespondingSourceObject>>,
}
...
pub struct Struct_modelInfos {
    pub biomeType: usize,
    pub models: Vec<Struct_m_CorrespondingSourceObject>,
    pub mtnModels: Vec<Struct_m_CorrespondingSourceObject>,
    pub explodeEffectPrefab: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_carryingAnimationInfos {
    pub workType: usize,
    pub liftUpClip: Struct_m_CorrespondingSourceObject,
    pub carryClip: Struct_m_CorrespondingSourceObject,
    pub liftdownClip: Struct_m_CorrespondingSourceObject,
    pub returnClip: Struct_m_CorrespondingSourceObject,
    pub rightHandTool: Struct_m_CorrespondingSourceObject,
    pub leftHandTool: Struct_m_CorrespondingSourceObject,
    pub bodyTool: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_animationInfos {
    pub workType: usize,
    pub animationClip: Struct_m_CorrespondingSourceObject,
    pub rightHandTool: Struct_m_CorrespondingSourceObject,
    pub leftHandTool: Struct_m_CorrespondingSourceObject,
    pub bodyTool: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_workPosInfos {
    pub workLocation: Struct_m_CorrespondingSourceObject,
    pub worker: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_tierObjectInfo {
    ...
    pub tierObjects: Vec<Struct_m_CorrespondingSourceObject>,
}
...
pub struct Struct_modelSlots {
    pub requireLv: usize,
    pub defaultModel: Struct_m_CorrespondingSourceObject,
    pub selectModels: Vec<Struct_m_CorrespondingSourceObject>,
    pub discardSelectModels: Vec<Struct_m_CorrespondingSourceObject>,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_imageInfoList {
    pub skillType: usize,
    pub colorSprite: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_bgInfos {
    pub kind: usize,
    pub spriteOn: Struct_m_CorrespondingSourceObject,
    pub sprietOff: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_biomeDisplays {
    pub biomeType: usize,
    pub obj: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_textInfo {
    pub textComponent: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_fontColorGradient {
    pub topLeft: Struct_m_BackGroundColor,
    pub topRight: Struct_m_BackGroundColor,
    pub bottomLeft: Struct_m_BackGroundColor,
    pub bottomRight: Struct_m_BackGroundColor,
}

#[derive(serde_derive::Serialize, serde_derive::Deserialize, Debug, PartialEq, Clone, Default)]
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_fontColor32 {
    pub serializedVersion: usize,
    pub rgba: usize,
}
...
pub struct Struct_m_Calls {
    pub m_Target: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_Arguments {
    pub m_ObjectArgument: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_serializationData {
    ...
    pub Prefab: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_list {
    pub cam: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_Options_1 {
    pub m_Text: String,
    pub m_Image: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_FontWeightTable {
    pub regularTypeface: Struct_m_CorrespondingSourceObject,
    pub italicTypeface: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_particleSystems {
    ...
    pub particleSystemGO: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_SpriteState {
    pub m_HighlightedSprite: Struct_m_CorrespondingSourceObject,
    pub m_PressedSprite: Struct_m_CorrespondingSourceObject,
    pub m_DisabledSprite: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_Colors {
    pub m_NormalColor: Struct_m_BackGroundColor,
    pub m_HighlightedColor: Struct_m_BackGroundColor,
    pub m_PressedColor: Struct_m_BackGroundColor,
    pub m_DisabledColor: Struct_m_BackGroundColor,
...
pub struct Struct_m_Navigation {
    pub m_Mode: usize,
    pub m_SelectOnUp: Struct_m_CorrespondingSourceObject,
    pub m_SelectOnDown: Struct_m_CorrespondingSourceObject,
    pub m_SelectOnLeft: Struct_m_CorrespondingSourceObject,
    pub m_SelectOnRight: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_FontData {
    pub m_Font: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_color {
    pub overrideState: usize,
    pub value: Struct_m_BackGroundColor,
}
...
pub struct Struct_vignette {
    pub m_Enabled: usize,
    pub m_Settings: Struct_m_Settings,
}
...
pub struct Struct_m_Settings {
    pub mode: usize,
    pub color: Struct_m_BackGroundColor,
    pub center: Struct_m_Center,
    pub intensity: f64,
    pub smoothness: f64,
    pub roundness: usize,
    pub mask: Struct_m_CorrespondingSourceObject,
    pub opacity: usize,
    pub rounded: usize,
}
...
pub struct Struct_m_Settings_2 {
    pub spectralTexture: Struct_m_CorrespondingSourceObject,
    pub intensity: f64,
}
...
pub struct Struct_m_Settings_3 {
    pub lut: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_linear {
    pub lift: Struct_m_BackGroundColor,
    pub gamma: Struct_m_BackGroundColor,
    pub gain: Struct_m_BackGroundColor,
}
...
pub struct Struct_log {
    pub slope: Struct_m_BackGroundColor,
    pub power: Struct_m_BackGroundColor,
    pub offset: Struct_m_BackGroundColor,
}
...
pub struct Struct_lensDirt {
    pub texture: Struct_m_CorrespondingSourceObject,
    pub intensity: usize,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_fog {
    pub m_Enabled: Option<usize>,
    pub m_Settings: Option<Struct_m_Settings_12>,
    pub enabled: Option<usize>,
    pub excludeSkybox: Option<usize>,
    pub fileID: Option<usize>,
}
...
pub struct Struct_levelInfos {
    pub level: usize,
    pub moneySpend: Option<f64>,
    pub moneyEarn: Option<f64>,
    pub population: Option<usize>,
    pub exp: Option<usize>,
}
...
pub struct Struct_techSelectBonusIconInfoList {
    pub name: String,
    pub defaultSprite: Struct_m_CorrespondingSourceObject,
    pub activeSprite: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_techGraphicInfoList {
    pub techType: usize,
    pub sprite: Struct_m_CorrespondingSourceObject,
    pub textColor: Struct_m_BackGroundColor,
}
...
pub struct Struct_synergyData {
    ...
    pub syngergyCondition: ::serde_yaml::Value,
}
...
pub struct NavMeshData {
    ...
    pub m_SourceBounds: Struct_m_Bounds,
...
pub struct NavMeshProjectSettings {
    ...
    pub m_LastAgentTypeID: isize,
    pub m_Settings: Vec<Struct_m_Settings_14>,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_Settings_14 {
    pub serializedVersion: usize,
    pub agentTypeID: isize,
    pub agentRadius: f64,
    pub agentHeight: usize,
    pub agentSlope: usize,
    pub agentClimb: f64,
...
pub struct NavMeshSettings {
    ...
    pub m_NavMeshData: Struct_m_CorrespondingSourceObject,
}
...
pub struct NetworkManager {
    ...
    pub m_AssetToPrefab: Struct_m_StateMachineTransitions,
}
...
pub struct OcclusionCullingSettings {
    ...
    pub m_OcclusionCullingData: Struct_m_CorrespondingSourceObject,
}
...
pub struct ParticleSystem {
    ...
    pub moveWithCustomTransform: Option<Struct_m_CorrespondingSourceObject>,
    pub scalingMode: Option<usize>,
    pub randomSeed: Option<isize>,
...
pub struct Struct_color0 {
    pub serializedVersion: usize,
    pub minMaxState: usize,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
...
pub struct Struct_maxGradient {
    pub serializedVersion: usize,
    pub key0: Struct_m_BackGroundColor,
    pub key1: Struct_m_BackGroundColor,
    pub key2: Struct_m_BackGroundColor,
    pub key3: Struct_m_BackGroundColor,
    pub key4: Struct_m_BackGroundColor,
    pub key5: Struct_m_BackGroundColor,
    pub key6: Struct_m_BackGroundColor,
    pub key7: Struct_m_BackGroundColor,
    pub ctime0: usize,
    pub ctime1: usize,
    pub ctime2: usize,
    pub ctime3: usize,
...
pub struct Struct_TrailModule {
    ...
    pub widthOverTrail: Struct_lifetime,
    pub colorOverTrail: Struct_colorOverTrail,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_colorOverTrail {
    pub serializedVersion: usize,
    pub maxGradient: Struct_maxGradient_1,
    pub minGradient: Struct_minGradient,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
    pub minMaxState: usize,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_minGradient {
    pub key0: Struct_key0,
    pub key1: Struct_key0,
    pub key2: Struct_key2,
    pub key3: Struct_key2,
    pub key4: Struct_key2,
    pub key5: Struct_key2,
    pub key6: Struct_key2,
    pub key7: Struct_key2,
    pub ctime0: usize,
    pub ctime1: usize,
    pub ctime2: usize,
    pub ctime3: usize,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_key2 {
    pub serializedVersion: Option<usize>,
    pub rgba: Option<usize>,
    pub r: Option<usize>,
    pub g: Option<usize>,
    pub b: Option<usize>,
    pub a: Option<usize>,
...
pub struct Struct_maxGradient_1 {
    pub key0: Struct_key0_1,
    pub key1: Struct_key2,
    pub key2: Struct_key2,
    pub key3: Struct_key2,
    pub key4: Struct_key2,
    pub key5: Struct_key2,
...
pub struct Struct_colorOverLifetime {
    pub serializedVersion: usize,
    pub maxGradient: Struct_maxGradient_2,
    pub minGradient: Struct_minGradient_1,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
    pub minMaxState: usize,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_minGradient_1 {
    pub key0: Struct_key0_1,
    pub key1: Struct_key1,
    pub key2: Struct_key2,
    pub key3: Struct_key2,
    pub key4: Struct_key2,
    pub key5: Struct_key2,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_maxGradient_2 {
    pub key0: Struct_key0_2,
    pub key1: Struct_key1_1,
    pub key2: Struct_key1_1,
    pub key3: Struct_key2,
    pub key4: Struct_key1,
    pub key5: Struct_key2,
    pub key6: Struct_key2,
    pub key7: Struct_key2,
    pub ctime0: usize,
...
pub struct Struct_LightsModule {
    pub enabled: usize,
    pub ratio: usize,
    pub light: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_subEmitters {
    pub emitter: Struct_m_CorrespondingSourceObject,
    #[serde(rename = "type")]
    pub field_type: usize,
...
pub struct Struct_TriggerModule {
    pub enabled: usize,
    pub collisionShape0: Struct_m_CorrespondingSourceObject,
    pub collisionShape1: Struct_m_CorrespondingSourceObject,
    pub collisionShape2: Struct_m_CorrespondingSourceObject,
    pub collisionShape3: Struct_m_CorrespondingSourceObject,
    pub collisionShape4: Struct_m_CorrespondingSourceObject,
    pub collisionShape5: Struct_m_CorrespondingSourceObject,
    pub inside: usize,
    pub outside: usize,
    pub enter: usize,
    pub exit: usize,
...
pub struct Struct_CollisionModule {
    ...
    pub plane0: Struct_m_CorrespondingSourceObject,
    pub plane1: Struct_m_CorrespondingSourceObject,
    pub plane2: Struct_m_CorrespondingSourceObject,
    pub plane3: Struct_m_CorrespondingSourceObject,
    pub plane4: Struct_m_CorrespondingSourceObject,
    pub plane5: Struct_m_CorrespondingSourceObject,
    pub m_Dampen: Struct_startDelay,
    pub m_Bounce: Struct_lifetime,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_gradient {
    pub serializedVersion: usize,
    pub maxGradient: Struct_maxGradient_3,
    pub minGradient: Struct_minGradient_2,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
    pub minMaxState: usize,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_minGradient_2 {
    pub key0: Struct_key2,
    pub key1: Struct_key2,
    pub key2: Struct_key2,
    pub key3: Struct_key2,
    pub key4: Struct_key2,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_maxGradient_3 {
    pub key0: Struct_key2,
    pub key1: Struct_key0,
    pub key2: Struct_key2,
    pub key3: Struct_key2,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_RotationBySpeedModule {
    pub enabled: usize,
    pub x: Struct_intensityCurve,
    pub y: Struct_intensityCurve,
    pub curve: Struct_lifetime,
...
pub struct Struct_NoiseModule {
    pub enabled: usize,
    pub strength: Struct_startDelay,
    pub strengthY: Struct_startDelay,
    pub strengthZ: Struct_startDelay,
    pub separateAxes: usize,
    pub frequency: f64,
    pub damping: usize,
    pub octaves: usize,
    ...
    pub remap: Struct_intensityCurve,
    pub remapY: Struct_intensityCurve,
    pub remapZ: Struct_intensityCurve,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_ClampVelocityModule {
    pub enabled: usize,
    pub x: Struct_startDelay,
    pub y: Struct_intensityCurve,
    pub z: Struct_intensityCurve,
    pub magnitude: Struct_startDelay,
    pub separateAxis: usize,
    pub inWorldSpace: usize,
    pub dampen: f64,
    pub multiplyDragByParticleSize: Option<usize>,
    pub multiplyDragByParticleVelocity: Option<usize>,
    pub drag: Option<Struct_positionAmount>,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_ForceModule {
    pub enabled: usize,
    pub x: Struct_intensityCurve,
    pub y: Struct_startDelay,
    pub z: Struct_intensityCurve,
    pub inWorldSpace: usize,
    pub randomizePerFrame: usize,
}
...
pub struct Struct_InheritVelocityModule {
    pub enabled: usize,
    pub m_Mode: usize,
    pub m_Curve: Struct_startDelay,
}

#[derive(serde_derive::Serialize, serde_derive::Deserialize, Debug, PartialEq, Clone, Default)]
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_VelocityModule {
    pub enabled: usize,
    pub x: Struct_lifetime,
    pub y: Struct_lifetime,
    pub z: Struct_lifetime,
    pub inWorldSpace: usize,
    pub orbitalX: Option<Struct_positionAmount>,
    pub orbitalY: Option<Struct_positionAmount>,
    pub orbitalZ: Option<Struct_positionAmount>,
    pub orbitalOffsetX: Option<Struct_positionAmount>,
    pub orbitalOffsetY: Option<Struct_positionAmount>,
    pub orbitalOffsetZ: Option<Struct_positionAmount>,
    pub radial: Option<Struct_sizeAmount>,
    pub speedModifier: Option<Struct_positionAmount>,
}
...
pub struct Struct_UVModule {
    pub enabled: usize,
    pub frameOverTime: Struct_lifetime,
...
pub struct Struct_ColorModule {
    pub enabled: usize,
    pub gradient: Struct_gradient_1,
}

#[derive(serde_derive::Serialize, serde_derive::Deserialize, Debug, PartialEq, Clone, Default)]
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_gradient_1 {
    pub serializedVersion: usize,
    pub maxGradient: Struct_maxGradient_4,
    pub minGradient: Struct_minGradient_3,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
    pub minMaxState: usize,
}
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_minGradient_3 {
    pub key0: Struct_key0_3,
    pub key1: Struct_key0_2,
    pub key2: Struct_key0_3,
    pub key3: Struct_key0_3,
    pub key4: Struct_key0_3,
    pub key5: Struct_key0_3,
    pub key6: Struct_key2,
    pub key7: Struct_key2,
    pub ctime0: usize,
    pub ctime1: usize,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_maxGradient_4 {
    pub key0: Struct_key0_2,
    pub key1: Struct_key0_2,
    pub key2: Struct_key0_3,
    pub key3: Struct_key0_3,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_RotationModule {
    pub enabled: usize,
    pub x: Struct_lifetime,
    pub y: Struct_lifetime,
    pub curve: Struct_lifetime,
...
pub struct Struct_EmissionModule {
    pub enabled: usize,
    pub serializedVersion: usize,
    pub rateOverTime: Struct_startDelay,
...
pub struct Struct_ShapeModule {
    ...
    pub m_Mesh: Struct_m_CorrespondingSourceObject,
    pub m_MeshRenderer: Struct_m_CorrespondingSourceObject,
    pub m_SkinnedMeshRenderer: Struct_m_CorrespondingSourceObject,
    ...
    pub m_Texture: Option<Struct_m_CorrespondingSourceObject>,
    ...
    pub m_Sprite: Option<Struct_m_CorrespondingSourceObject>,
    pub m_SpriteRenderer: Option<Struct_m_CorrespondingSourceObject>,
}
...
pub struct Struct_m_MeshSpawn {
    pub mode: usize,
    pub spread: usize,
    pub speed: Struct_positionAmount,
}
...
pub struct Struct_InitialModule {
    ...
    pub startSpeed: Struct_lifetime,
    pub startColor: Struct_startColor,
    pub startSize: Struct_lifetime,
    pub startSizeY: Struct_lifetime,
    pub startSizeZ: Struct_startDelay,
    pub startRotationX: Struct_startDelay,
    pub startRotationY: Struct_startDelay,
    pub startRotation: Struct_lifetime,
    pub randomizeRotationDirection: f64,
    pub maxNumParticles: usize,
    pub size3D: usize,
    pub rotation3D: usize,
    pub gravityModifier: Struct_lifetime,
}

#[derive(serde_derive::Serialize, serde_derive::Deserialize, Debug, PartialEq, Clone, Default)]
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_startColor {
    pub serializedVersion: usize,
    pub maxGradient: Struct_maxGradient_5,
    pub minGradient: Struct_minGradient_2,
    pub minColor: Struct_m_BackGroundColor,
    pub maxColor: Struct_m_BackGroundColor,
    pub minMaxState: usize,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_maxGradient_5 {
    pub key0: Struct_key0_2,
    pub key1: Struct_key0_2,
    pub key2: Struct_key1,
    pub key3: Struct_key2,
    pub key4: Struct_key2,
    pub key5: Struct_key2,
    pub key6: Struct_key2,
...
pub struct ParticleSystemRenderer {
    ...
    pub m_StaticBatchRoot: Struct_m_CorrespondingSourceObject,
    pub m_ProbeAnchor: Struct_m_CorrespondingSourceObject,
    pub m_LightProbeVolumeOverride: Struct_m_CorrespondingSourceObject,
    pub m_ScaleInLightmap: usize,
    pub m_PreserveUVs: usize,
    ...
    pub m_Mesh: Struct_m_CorrespondingSourceObject,
    pub m_Mesh1: Struct_m_CorrespondingSourceObject,
    pub m_Mesh2: Struct_m_CorrespondingSourceObject,
    pub m_Mesh3: Struct_m_CorrespondingSourceObject,
    pub serializedVersion: Option<usize>,
    pub m_DynamicOccludee: Option<usize>,
    pub m_StitchLightmapSeams: Option<usize>,
    pub m_SortingLayer: Option<usize>,
...
pub struct Physics2DSettings {
    ...
    pub m_DefaultMaterial: Struct_m_CorrespondingSourceObject,
    ...
    pub m_ColliderAwakeColor: Struct_m_BackGroundColor,
    pub m_ColliderAsleepColor: Struct_m_BackGroundColor,
    pub m_ColliderContactColor: Struct_m_BackGroundColor,
    pub m_ColliderAABBColor: Struct_m_BackGroundColor,
...
pub struct PhysicsManager {
    ...
    pub m_WorldBounds: Struct_m_Bounds,
...
pub struct PlayerSettings {
    ...
    pub defaultCursor: Struct_m_CorrespondingSourceObject,
    pub cursorHotspot: Struct_m_Center,
    pub m_SplashScreenBackgroundColor: Struct_m_BackGroundColor,
    ...
    pub m_VirtualRealitySplashScreen: Struct_m_CorrespondingSourceObject,
    pub m_HolographicTrackingLossScreen: Struct_m_CorrespondingSourceObject,
    ...
    pub buildNumber: Struct_m_StateMachineTransitions,
    ...
    pub iPhoneSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhoneHighResSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhoneTallHighResSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhone47inSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhone55inPortraitSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhone55inLandscapeSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhone58inPortraitSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPhone58inLandscapeSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPadPortraitSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPadHighResPortraitSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPadLandscapeSplashScreen: Struct_m_CorrespondingSourceObject,
    pub iPadHighResLandscapeSplashScreen: Struct_m_CorrespondingSourceObject,
    pub appleTVSplashScreen: Struct_m_CorrespondingSourceObject,
    pub appleTVSplashScreen2x: Struct_m_CorrespondingSourceObject,
    ...
    pub iOSLaunchScreenPortrait: Struct_m_CorrespondingSourceObject,
    pub iOSLaunchScreenLandscape: Struct_m_CorrespondingSourceObject,
    pub iOSLaunchScreenBackgroundColor: Struct_m_fontColor32,
    ...
    pub iOSLaunchScreeniPadImage: Struct_m_CorrespondingSourceObject,
    pub iOSLaunchScreeniPadBackgroundColor: Struct_m_fontColor32,
    ...
    pub androidSplashScreen: Struct_m_CorrespondingSourceObject,
    ...
    pub resolutionDialogBanner: Struct_m_CorrespondingSourceObject,
    ...
    pub m_TemplateCustomTags: Struct_m_StateMachineTransitions,
    ...
    pub switchIcons_0: Struct_m_CorrespondingSourceObject,
    pub switchIcons_1: Struct_m_CorrespondingSourceObject,
    pub switchIcons_2: Struct_m_CorrespondingSourceObject,
    pub switchIcons_3: Struct_m_CorrespondingSourceObject,
    pub switchIcons_4: Struct_m_CorrespondingSourceObject,
    pub switchIcons_5: Struct_m_CorrespondingSourceObject,
    pub switchIcons_6: Struct_m_CorrespondingSourceObject,
    pub switchIcons_7: Struct_m_CorrespondingSourceObject,
    pub switchIcons_8: Struct_m_CorrespondingSourceObject,
    pub switchIcons_9: Struct_m_CorrespondingSourceObject,
    pub switchIcons_10: Struct_m_CorrespondingSourceObject,
    pub switchIcons_11: Struct_m_CorrespondingSourceObject,
    pub switchIcons_12: Struct_m_CorrespondingSourceObject,
    pub switchIcons_13: Struct_m_CorrespondingSourceObject,
    pub switchIcons_14: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_0: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_1: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_2: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_3: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_4: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_5: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_6: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_7: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_8: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_9: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_10: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_11: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_12: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_13: Struct_m_CorrespondingSourceObject,
    pub switchSmallIcons_14: Struct_m_CorrespondingSourceObject,
    ...
    pub monoEnv: Option<()>,
    pub splashScreenBackgroundSourceLandscape: Struct_m_CorrespondingSourceObject,
    pub splashScreenBackgroundSourcePortrait: Struct_m_CorrespondingSourceObject,
    ...
    pub scriptingDefineSymbols: Struct_m_StateMachineTransitions,
    pub platformArchitecture: Struct_m_StateMachineTransitions,
    pub scriptingBackend: Struct_scriptingBackend,
    pub il2cppCompilerConfiguration: Struct_m_StateMachineTransitions,
    pub managedStrippingLevel: Struct_scriptingBackend,
    pub incrementalIl2cppBuild: Struct_m_StateMachineTransitions,
    pub allowUnsafeCode: usize,
    pub additionalIl2CppArgs: Option<()>,
    pub scriptingRuntimeVersion: usize,
    pub apiCompatibilityLevelPerPlatform: Struct_m_StateMachineTransitions,
    ...
    pub wsaImages: Struct_m_StateMachineTransitions,
    ...
    pub metroTileBackgroundColor: Struct_m_BackGroundColor,
    pub metroSplashScreenBackgroundColor: Struct_m_BackGroundColor,
    pub metroSplashScreenUseBackgroundColor: usize,
    pub platformCapabilities: Struct_m_StateMachineTransitions,
    pub metroTargetDeviceFamilies: Struct_m_StateMachineTransitions,
    ...
    pub XboxOneGameRating: Struct_m_StateMachineTransitions,
    pub XboxOneIsContentPackage: usize,
    pub XboxOneEnableGPUVariability: usize,
    pub XboxOneSockets: Struct_m_StateMachineTransitions,
    pub XboxOneSplashScreen: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_daydream {
    pub daydreamIconForeground: Struct_m_CorrespondingSourceObject,
    pub daydreamIconBackground: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_Icons {
    pub m_Textures: Vec<Struct_m_CorrespondingSourceObject>,
    pub m_Width: usize,
    pub m_Height: usize,
    pub m_Kind: usize,
...
pub struct Struct_m_Icons_1 {
    pub serializedVersion: usize,
    pub m_Icon: Struct_m_CorrespondingSourceObject,
    pub m_Width: usize,
    pub m_Height: usize,
    pub m_Kind: usize,
}
...
pub struct Struct_m_AndroidBanners {
    pub width: usize,
    pub height: usize,
    pub banner: Struct_m_CorrespondingSourceObject,
}
...
pub struct Prefab {
    ...
    pub m_ParentPrefab: Struct_m_CorrespondingSourceObject,
    pub m_RootGameObject: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct Struct_m_Modification {
    pub m_TransformParent: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_Modifications {
    pub target: Struct_m_CorrespondingSourceObject,
    pub propertyPath: String,
    pub value: Option<::serde_yaml::Value>,
    pub objectReference: Struct_m_CorrespondingSourceObject,
}
...
pub struct PrefabInstance {
    ...
    pub m_SourcePrefab: Struct_m_CorrespondingSourceObject,
}
...
pub struct Struct_m_Modification_1 {
    pub m_TransformParent: Struct_m_CorrespondingSourceObject,
    pub m_Modifications: Vec<Struct_m_Modifications>,
    pub m_RemovedComponents: Vec<Struct_m_CorrespondingSourceObject>,
}
...
pub struct Preset {
    ...
    pub m_PrefabAsset: Struct_m_CorrespondingSourceObject,
    pub m_Name: String,
    pub m_TargetType: Struct_m_TargetType,
...
#[allow(non_snake_case)]
#[allow(non_camel_case_types)]
pub struct Struct_m_TargetType {
    pub m_NativeTypeID: usize,
    pub m_ManagedTypePPtr: Struct_m_CorrespondingSourceObject,
...
pub struct Struct_m_DefaultList {
    #[serde(rename = "type")]
    pub field_type: Struct_m_TargetType,
...
pub struct Struct_defaultPresets {
    pub m_Preset: Struct_m_CorrespondingSourceObject,
}
...
pub struct RectTransform {
    ...
    pub m_Children: Option<Vec<Struct_m_CorrespondingSourceObject>>,
    pub m_Father: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct ReflectionProbe {
    ...
    pub m_BackGroundColor: Struct_m_BackGroundColor,
    pub m_CullingMask: Struct_m_CullingMask,
    ...
    pub m_CustomBakedTexture: Struct_m_CorrespondingSourceObject,
}
...
pub struct RenderSettings {
    ...
    pub serializedVersion: usize,
    pub m_Fog: usize,
    pub m_FogColor: Struct_m_BackGroundColor,
    pub m_FogMode: usize,
    pub m_FogDensity: f64,
    pub m_LinearFogStart: usize,
    pub m_LinearFogEnd: usize,
    pub m_AmbientSkyColor: Struct_m_BackGroundColor,
    pub m_AmbientEquatorColor: Struct_m_BackGroundColor,
    pub m_AmbientGroundColor: Struct_m_BackGroundColor,
    pub m_AmbientIntensity: usize,
    pub m_AmbientMode: usize,
    pub m_SubtractiveShadowColor: Option<Struct_m_BackGroundColor>,
    pub m_SkyboxMaterial: Struct_m_CorrespondingSourceObject,
    pub m_HaloStrength: f64,
    pub m_FlareStrength: usize,
    pub m_FlareFadeSpeed: usize,
    pub m_HaloTexture: Struct_m_CorrespondingSourceObject,
    pub m_SpotCookie: Struct_m_CorrespondingSourceObject,
    ...
    pub m_CustomReflection: Struct_m_CorrespondingSourceObject,
    pub m_Sun: Struct_m_CorrespondingSourceObject,
    pub m_IndirectSpecularColor: Option<Struct_m_BackGroundColor>,
...
pub struct SpriteRenderer {
    ...
    pub m_SortingLayerID: usize,
    pub m_SortingOrder: usize,
    pub m_Sprite: Struct_m_CorrespondingSourceObject,
    pub m_Color: Struct_m_BackGroundColor,
    pub m_FlipX: usize,
    pub m_FlipY: usize,
    pub m_CorrespondingSourceObject: Option<Struct_m_CorrespondingSourceObject>,
...
pub struct Terrain {
    ...
    pub m_Enabled: usize,
    pub serializedVersion: usize,
    pub m_TerrainData: Struct_m_CorrespondingSourceObject,
    ...
    pub m_LegacySpecular: Struct_m_fontColor32,
    pub m_LegacyShininess: f64,
    pub m_MaterialTemplate: Struct_m_CorrespondingSourceObject,
...
pub struct TerrainLayer {
    ...
    pub m_PrefabAsset: Struct_m_CorrespondingSourceObject,
    pub m_Name: String,
    pub m_DiffuseTexture: Struct_m_CorrespondingSourceObject,
    pub m_NormalMapTexture: Struct_m_CorrespondingSourceObject,
    pub m_MaskMapTexture: Struct_m_CorrespondingSourceObject,
    pub m_TileSize: Struct_m_Center,
    pub m_TileOffset: Struct_m_Center,
    pub m_Specular: Struct_m_BackGroundColor,
...
pub struct TextMesh {
    ...
    pub m_RichText: usize,
    pub m_Font: Struct_m_CorrespondingSourceObject,
    pub m_Color: Struct_m_fontColor32,
}
...
pub struct UnityConnectSettings {
    ...
    pub PerformanceReportingSettings: Struct_dithering,
}
...
pub struct VFXManager {
    pub m_ObjectHideFlags: usize,
    pub m_IndirectShader: Struct_m_CorrespondingSourceObject,
    pub m_CopyBufferShader: Struct_m_CorrespondingSourceObject,
    pub m_SortShader: Struct_m_CorrespondingSourceObject,
    pub m_RenderPipeSettingsPath: Option<()>,
    pub m_FixedTimeStep: f64,
